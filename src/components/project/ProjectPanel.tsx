      ...
      >
        ...
        <div className="mt-[2vh] grid grid-cols-1 gap-[2.5vh] lg:mt-[3vh] lg:grid-cols-[0.9fr_1.1fr] lg:gap-10">
          ...
          <div className="relative" data-cursor={noteOpen ? "NOTE" : "VIEW"}>
            <motion.div
              className="relative flex h-[42svh] min-h-[340px] sm:min-h-[360px] max-h-[480px] w-full flex-col overflow-hidden rounded-xl border-2 p-3 sm:p-4 lg:p-4.5 lg:h-[48svh] lg:min-h-[380px]"
